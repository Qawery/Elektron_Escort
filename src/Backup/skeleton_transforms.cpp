/**
	Program publikuje transformaty TF centrum masy i szkieletu osób wykrytych przez NITE.
	Publikuje również wykryte przez osoby pozy (np. pozę "psi).
*/
...
string parentFrame("skeleton_transforms");	//TODO podpięcie pod kinecta
...
{
	ros::init(argc, argv, "skeleton_transforms");	//Inicializacja ROS.
