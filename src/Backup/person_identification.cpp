...
void XN_CALLBACK_TYPE User_NewUser(xn::UserGenerator& generator, XnUserID nId, void* pCookie) 
{
	...
	if(calib_from_file)
	{
		generator.GetSkeletonCap().LoadCalibrationDataFromFile(nId, "calibration.bin");
...
{
	ros::init(argc, argv, "person_identification");
	ros::NodeHandle nh;

	string configFilename = ros::package::getPath("elektron_escort") + "/OpenNi_config.xml";
