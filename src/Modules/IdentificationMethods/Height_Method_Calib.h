#ifndef ELEKTRON_ESCORT_Height_Method_Calib_H
#define ELEKTRON_ESCORT_Height_Method_Calib_H

#define DEFAULT_NUMBER_OF_TEMPLATE_SAMPLES 60
#define DEFAULT_HEIGHT_TOLERANCE 200.0
...
class Height_Method_Calib : public Identification_Method {
public:
    void ClearTemplate();
...
#endif //ELEKTRON_ESCORT_Height_Method_Calib_H
