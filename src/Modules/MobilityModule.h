...
#define DEFAULT_DISTANCE_TO_KEEP 2500.0
#define DEFAULT_MAX_LINEAR_SPEED 0.254
#define DEFAULT_MAX_LINEAR_SPEED_DISTANCE 4000.0
#define DEFAULT_POSITION_TOLERANCE 100.0
#define DEFULT_MAX_FOLLOWING_TURNING_SPEED 0.36
#define DEFAULT_MAX_FOLLOWING_TURNING_SPEED_DISTANCE 2000.0
